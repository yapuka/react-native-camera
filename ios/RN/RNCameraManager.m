...
RCT_EXPORT_VIEW_PROPERTY(onCameraUpdate, RCTDirectEventBlock);
...
{
    return @[@"onCameraReady", @"onCameraUpdate", @"onMountError", @"onBarCodeRead", @"onFacesDetected", @"onPictureSaved", @"onTextRecognized"];
}
